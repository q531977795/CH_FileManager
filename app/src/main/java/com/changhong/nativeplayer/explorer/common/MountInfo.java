            ...
            if (service != null) {
                ...
                for (int i = 0; i < index; i++) {
                    ...
                    if (mountList.get(i).mLabel != null) {
                        label[i] = mountList.get(i).mDiskLabel + ": " + mountList.get(i).mLabel;
                    } else {
                        label[i] = mountList.get(i).mDiskLabel;
                    }
                    Log.e("libeibei", "111 === label[i] = " + label[i]);
                    //libeibei add for remove Disk character begin
                    String str = label[i];
                    if (str.equals("C")) {
                        label[i] = "";
                    ...
                    Log.e("libeibei", "222 === label[i] = " + label[i]);
                    //libeibei add for remove Disk character end
                    partition[i] = label[i];
